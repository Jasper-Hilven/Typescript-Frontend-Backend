...
module frontend {
  export class AppFactory {
    ...
    public BuildApp() {
      ...
      // Build the content
      let formCreator = new FormCreator(divLayout, hFactory);
      let footerText = "copyright, 2016 PayTogether, Inc.";
      let createFooter = () => divLayout.GetFooter(footerText);
      let pages = <[IPageController]>[];
      let mainPage = new MainPage(divLayout, hFactory, createNavigator(), createFooter(), myAppInfo, backendProxy, title);
      pages.push(mainPage);
